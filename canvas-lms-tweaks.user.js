...
(function () {
    ...
    if (window.location.href.includes("instructure.com")) {
        injectCSS(`
            ...
            a.ic-app-header__logomark { /* UX: Remove the clipart-looking icon that is your organizations logo from the leftmost sidebar */
                display: none !important;
            }
            div.Grouping-styles__root.planner-grouping a { /* UX: Remove class banner images from dashboard in list view (makes them solid colors) */
    ...
    window.addEventListener("load", function () { // UX: When visiting the dashboard, automatically scroll down to the actual dashboard rather than the announcements
